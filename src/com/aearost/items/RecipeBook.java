...
public class RecipeBook {
	...
	public static ItemStack getRecipeBook() {
		...
		pages.add(Utils.translateToColor("&l&nApple Cinnamon Tea\n\n&r&oJust a hint of tree bark\n\n&rIngredients:\n- 1 tea leaf\n- 1 apple\n- 1 wheat seeds\n- 1 dark oak log\n\nEffects:\n- Haste II (180s)"));
		pages.add(Utils.translateToColor("&l&nChocolate Tea\n\n&r&oSweet goodness!\n\n&rIngredients:\n- 1 tea leaf\n- 1 milk bucket\n- 1 cocoa beans\n- 1 sugar\n\nEffects:\n- Speed IV (120s)"));
		pages.add(Utils.translateToColor("&l&nJasmine Tea\n\n&r&oThe sweet taste of blossoms\n\n&rIngredients:\n- 1 tea leaf\n- 1 white tulip\n- 1 peony\n\nEffects:\n- Invisibility (15s)"));
		pages.add(Utils.translateToColor("&l&nMatcha Tea\n\n&r&oThe Japanese flavor you needed\n\n&rIngredients:\n- 1 tea leaf\n- 1 sugar\n- 1 leaves (any kind)\n\nEffects:\n- Jump III (120s)"));
		pages.add(Utils.translateToColor("&l&nT8 Tea\n\n&r&oEver hear of V8?\n\n&rIngredients:\n- 1 tea leaf\n- 2 carrots\n- 2 beetroots\n- 2 sweet berries\n- 1 melon slice\n\nEffects:\n- Regeneration II (60s)"));
		pages.add(Utils.translateToColor("&l&nWhite Dragon Tea\n\n&r&oDelicious tea?\n\nIngredients:\n- 1 tea leaf\n- 1 azure bluet\n- 1 white tulip\n\nEffects:\n- Instant Health III"));
		pages.add(Utils.translateToColor("&l&nWhite Jade Tea\n\n&r&oDeadly poison?\n\nIngredients:\n- 1 tea leaf\n- 1 lily of the valley\n- 1 white tulip\n\nEffects:\n- Slowness III (180s)"));
